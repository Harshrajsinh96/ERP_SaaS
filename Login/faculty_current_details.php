...
function validateForm()
{
  ...
  {
    if ((designation.value).length > 30)
  {
    
    document.getElementById('error1').innerHTML = "Max Size Is 30!";
  }
  else
  {
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Faculty Current Details</li>
          </ol>
        </section>
        <section>
          <center>
          ...
          <fieldset>
    <legend><h1>Faculty Current Details</h1></legend>
    <table cellpadding="7px">
    <form name="faculty_current_details" action="faculty_current_details_conn.php" method="POST">
      
      <tr><td><label>Discipline ID :</label></td>
      <td><select name="discipline_id" id="discipline_id"" required="required" onchange="getBranch(this.value),setDiscipline(this.value)">
      ...
      <td><input type="text" size="30" name="designation" id="designation" required="required" onblur="validateForm()" /><span id="error1"></span></td></tr>
