...
<html>
  <head>
    ...
    {
      var numbers = /^[0-9]+$/; 
    if (discipline_code.value.match(numbers))
    {
    if ((discipline_code.value).length > 2)
    {
    ...
    {
    var letters = /^[A-Z a-z]+$/;
    if (discipline_name.value.match(letters))
    {
    if ((discipline_name.value).length > 40)
   {
   document.getElementById('error2').innerHTML = "Max Size Is 40!";
   }
   else
   {
  ...
  {
  var letters = /^[A-Z.a-z]+$/;
  if (discipline_sname.value.match(letters))
  {
    if ((discipline_sname.value).length > 6)
  {
    document.getElementById('error3').innerHTML = "Max Size Is 6!";
  }
  else
  {
  ...
  {
   var numbers = /^[0-9]+$/; 
   if (num_of_sem.value.match(numbers))
  {
    if ((num_of_sem.value).length > 2)
  {
    document.getElementById('error4').innerHTML = "Max Size Is 2!";
  }
  else
  {
  ...
  {
    document.getElementById('error4').innerHTML = "Only Numbers Please!";
    return false;
  }
  }
  </script>
 ...
 <body class="skin-blue">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Discipline Master</li>
          </ol>
        </section>
        <section>
          <center>
      ...
      <fieldset>
      <legend><h1>Discipline Master</h1></legend>
      <table cellpadding="7px">
      <form name="discipline_master" action="discipline_master_conn.php" method="POST">

      <tr><td><label>Discipline Code:</label></td>
      <td><input type="number" size="2" name="discipline_code" id="discipline_code" required="required" onblur="validateForm()" /><span id="error1"></span></td></tr>
      
      <tr><td><label>Discipline Name:</label></td>
      <td><input type="text" size="40" name="discipline_name" id="discipline_name" required="required" onblur="validateForm1()" /><span id="error2"></span></td></tr>
      
      <tr><td><label>Discipline Short Name:</label></td>
      <td><input type="text" size="6" name="discipline_sname" id="discipline_sname" required="required" onblur="validateForm2()" /><span id="error3"></span></td></tr>

      <tr><td><label>Number of Semester:</label></td>
      <td><input type="number" size="2" name="num_of_sem" id="num_of_sem" required="required" onblur="validateForm3()" /><span id="error4"></span></td></tr>
