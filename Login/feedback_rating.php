...
<html>
  ...
  if ((rating_value.value).length>15)
  {
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Feedback Rating</li>
          </ol>
        </section>
        <section>
          <center>
          ...
          <fieldset>
    <legend><h1>Feedback Rating</h1></legend>
    <table cellpadding="7px">
    <form name="feedback_rating" action="feedback_rating_conn.php" method="POST">

    <tr><td><label>Criteria :</label></td>
    <td><input type="varchar" size="15" name="rating_value" id="rating_value" required="required"
