...
<html>
  <head>
    ...
    function validateForm() 
      {
        var text = /^[A-Za-z]+$/;
        if(branch_name.value.match(text))
        {
          if((branch_name.value).length>100)
          {
        document.getElementById('branchname').innerHTML = "Max Size is 100!";
        }
        else
        {
        ...
        {
        document.getElementById('branchname').innerHTML = "Only Alphabets Please!";
        }
      }
      function validateForm1()
      {
        if((branch_code.value).length>2)
        {
          document.getElementById('branchcode').innerHTML = "No More Than 2 Digits!";
        }
        else
        {
          document.getElementById('branchcode').innerHTML = "";
        }
      }
    </script>
 </head>
 ...
 <body class="skin-blue">
    ...
    <fieldset>
    <legend><h1>Branch Master</h1></legend>
    <table cellpadding="7px">
    <form name="branch_master" action="branch_master_conn.php" method="POST">

      <tr><td><label>Discipline ID :</label></td>
        <td><select name="discipline_id" id="discipline_id" required="required">
      ...
      <tr><td><label>Branch Code :</label></td>
      <td><input type="number" size="2" name="branch_code" id="branch_code" required="required" onblur="validateForm1()"/><span id="branchcode"></span></td></tr>
      
      <tr><td><label>Branch Name:</label></td>
      <td><input type="text" size="100" name="branch_name" id="branch_name" required="required" onblur="validateForm()"/><span id="branchname"></span></td></tr>
