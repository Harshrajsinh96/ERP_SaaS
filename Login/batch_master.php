...
<html>
  <head>
    ...
    {
    if ((batch.value).length > 5)
    {
    document.getElementById('error1').innerHTML = "Max Size Is 5!";
    }
    else
    {
 ...
 <body class="skin-blue">
    <div class="wrapper">
      ...
      <fieldset>
      <legend><h1>Batch Master</h1></legend>
      <table cellpadding="7px">
      <form name="batch_master" action="batch_master_conn.php" method="POST">

      <tr><td><label>Batch :</label></td>
      <td><input type="varchar" size="5" name="batch" id="batch" required="required" onblur="validateForm()" /><span id="error1"></span></td></tr>
      
      <tr><td aligh="right"><input type="submit" value="Submit" name="Submit"/>&nbsp;&nbsp;&nbsp;</td>
