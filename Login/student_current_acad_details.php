...
<html>
  ...
  {
    document.getElementById('enrno').innerHTML = "your Enrollment number should contain 12 digits";
  }
  else
  {
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Student Current Academic Details</li>
          </ol>
        </section>
        <section>
          <center>
          ...
          <fieldset>
    <legend><h1>Student Current Academic Details</h1></legend>
    <table cellpadding="7px">
    <form name="student_current_acad_details" action="student_current_acad_details_conn.php" method="POST">
      ...
      <tr><td><label>Branch Name :</label></td>
        ...
        <td><select name="sub_id" id="sub_id" required="required" onchange="selectFaculty()">
        ...
        <tr><td><label>Batch ID :</label></td>
        <td><select name="batch_id" id="batch_id" required="required">
        <option value = "">Select Batch</option>
        <?php
          $query = "SELECT * FROM batch_master ORDER BY batch"; 
          $results = mysqli_query($connection, $query);
