...
<html>
  <head>
    ...
    <script>
      ...
      {
        var text = /^[A-Za-z]+$/;
        if(dept_name.value!=(text)) 
        {
        if ((dept_name.value.)length>30)
        {
          document.getElementById('depname').innerHTML = "Only 30 Charactors Please!";
        }
        else
        {
        ...
        {
          document.getElementById('depname').innerHTML = "Only Alphabets Please!";
        }
      }
      </script>
 </head>
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Staff Department Master</li>
          </ol>
        </section>
        <section>
          <center>
          ...
          <fieldset>
    <legend><h1>Staff Department Master</h1></legend>
    <table cellpadding="7px">
    <form name="staff_department_master" action="staff_department_master_conn.php" method="POST">

    <tr><td><label>Department Name :</label></td>
      <td><input type="varchar" size="30" name="dept_name" id="dept_name" required="required" onblur="validateForm()" /><span id="depname"></span></td></tr>
