    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section>
          ...
          <fieldset>
    <legend><h1>User Master</h1></legend>
    <table cellpadding="7px">
    <form name="user_master" action="user_master_conn.php" method="POST">

      <tr><td><label>User Type:</label></td>
      <td><input type="varchar" size="10" name="user_type" id="user_type" required="required" onblur="validateForm()" /><span id="error1"></span></td></tr>
