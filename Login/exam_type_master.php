...
<html>
 ...
 <body class="skin-blue">
    ...
    <fieldset>
    <legend><h1>Exam Type Master</h1></legend>
    <table cellpadding="7px">
    <form name="exam_type_master" action="exam_type_master_conn.php" method="POST">

    <tr><td><label>Exam Type:</label></td>
    <td><input type="varchar" size="15" name="exam_type" id="exam_type" required="required" onblur="validateForm()" /><span id="error1"></span></td></tr>
