      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Subject Allocation Master</li>
          </ol>
        </section>
        <section>
          <center>
          ...
          <fieldset>
    <legend><h1>Subject Allocation Master</h1></legend>
    <table cellpadding="7px">
    <form name="sub_alloc_master" action="sub_alloc_master_conn.php" method="POST">
      ...
      <tr><td><label>Semester :</label></td>
        <td><select name="sem_id" id="sem_id" required="required" onchange="selectSubject(this.value)">
      ...
      <tr><td><label>Subject ID :</label></td>
