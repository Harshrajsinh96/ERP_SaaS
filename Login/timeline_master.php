...
<html>
    ...
    function validateForm1()
  {
   ...
   {
    document.getElementById('top').innerHTML = "No More Then 255 Charactors!!!";
   }
   else
   {
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Timeline Master</li>
          </ol>
        </section>
        <section>
          <center>
<fieldset>
    <legend><h1>Timeline Master</h1></legend>
    <table cellpadding="7px">
    <form name="timeline_master" action="timeline_master_conn.php" method="POST" enctype='multipart/form-data'>
      ...
      <tr><td><label>Division :</label></td>
        <td><select name="div_id" id="div_id" required="required">
                <option value = "">Select Division</option>
                </select></td></tr>
                
        <tr><td><label>Subject :</label></td>
        <td><select name="sub_id" id="sub_id" required="required" onchange="selectFaculty(this.value)">
                <option value = "">Select Sub</option>
                </select></td></tr>
      <tr><td><label>Day :</label></td>
      <td><select name="day" id="day" required="required">      <option value = "">Select Day</option>
      ...
      <tr><td><label>Lecture No :</label></td>
      <td><select name="lec_no" id="lec_no" required="required">
      ...
      <td><input type="text" name="topic" id="topic" required="required" onblur="validateForm1()" /><span id="top"></span></td></tr>
      
      <tr><td><label>Link:</label></td>
      <td><input type='file' name="mp" required="required"></td></tr>

      <tr><td><label>Faculty ID :</label></td>
        <td><select name="faculty_id" id="faculty_id" required="required">  
