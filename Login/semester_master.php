...
{
  if (sem_no.value.length>3) 
  {
    document.getElementById('semno').innerHTML="Semester Number Should Be Less Than 3";
  }
  else
  {
    document.getElementById('semno').innerHTML="";
  }
}
</script>
 </head>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section>
          ...
          <fieldset>
    <legend><h1>Semester Master</h1></legend>
    <table cellpadding="7px">
    <form name="semester_master" action="semester_master_conn.php" method="POST">
      ...
      <tr><td><label>Semester Number :</label></td>
      <td><input type="Number" size="2" name="sem_no" id="sem_no" required="required" onblur="validateForm()" /><span id="semno"></span></td></tr>
