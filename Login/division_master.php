...
<html>
  <head>
    ...
    {
    var letters = /^[A-Za-z]+$/;
    if (division.value.match(letters))
    {
    if ((division.value).length > 1)
    {
      document.getElementById('error1').innerHTML = "Max Size Is 1!";
    }
    else
    {
 ...
 <body class="skin-blue">
    <div class="wrapper">
      ...
      <fieldset>
      <legend><h1>Division Master</h1></legend>
      <table cellpadding="7px">
      <form name="division_master" action="division_master_conn.php" method="POST">

      <tr><td><label>Discipline ID :</label></td>
        <td><select name="discipline_id" id="discipline_id" required="required" onchange="getBranch(this.value),getSem(this.value)">
      ...
      <tr><td><label>Branch ID :</label></td>
        <td><select name="branch_id" id="branch_id" required="required">
      ...
      <td><input type="varchar" size="1" name="division" id="division" required="required" onblur="validateForm()" /><span id="error1"></span></td></tr>
