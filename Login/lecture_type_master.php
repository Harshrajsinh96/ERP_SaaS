...
<html>
  <head>
    ...
    {
        var letters = /^[A-Za-z]+$/;
  if (lecture_type.value.match(letters))
  {
    if ((lecture_type.value).length > 10)
  {
    
    document.getElementById('error1').innerHTML = "Max Size Is 10!";
  }
  else
  {
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Lecture Type Master</li>
          </ol>
        </section>
        <section>
          <center>
          ...
          <fieldset>
    <legend><h1>Lecture Type Master</h1></legend>
    <table cellpadding="7px">
    <form name="lecture_type_master" action="lecture_type_master_conn.php" method="POST">

    <tr><td><label>Lecture Type :</label></td>
    <td><input type="varchar" size="10" name="lecture_type" id="lecture_type" required="required"
