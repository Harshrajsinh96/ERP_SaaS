...
<html>
  <head>
    ...
    {
    if ((year.value).length > 11)
    {
    document.getElementById('error1').innerHTML = "max Size Is 11!";
    }
    else
    {
 ...
 <body class="skin-blue">
    <div class="wrapper">
      ...
      <fieldset>
      <legend><h1>Academic Calender</h1></legend>
      <table cellpadding="7px">
      <form name="academic_calender" action="academic_calender_conn.php" method="POST">
      <tr><td><label>Start Date :</label></td>
      <td><input type="date" name="start_date" id="start_date" required="required"/></td></tr>
      <tr><td><label>End Date :</label></td>
      <td><input type="date" name="end_date" id="end_date" required="required"/></td></tr>    
      <tr><td><label>Discipline Name :</label></td>
      <td><select name="discipline_id" onchange="getSem(this.value)">
      ...
      <td><input type="varchar" size="10" name="year" id="year" required="required" onblur="validateForm()"/><span id="error1"></span></td></tr>
