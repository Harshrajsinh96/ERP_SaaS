...
<html>
  <head>
    ...
    function validateForm()
    {
      ...
      var numbers = /^[0-9]+$/; 
  if (institute_code.value.match(numbers))
  {
    if ((institute_code.value).length != 3)
  {
    
    document.getElementById('error1').innerHTML = "Size Is 3!";
  }
  else
  {
    ...
    var letters = /^[A-Z a-z]+$/;
  if (institute_name.value.match(letters))
  {
    if ((institute_name.value).length > 50)
  {
    
    document.getElementById('error2').innerHTML = "Max Size Is 50!";
  }
  else
  {
    ...
    function validateForm2() 
     {
    var numbers = /^[0-9]+$/; 
  if (est_year.value.match(numbers))
  {
    if ((est_year.value).length != 4)
  {
    
    document.getElementById('error3').innerHTML = "Size Is 4!";
  }
  else
  {
 ...
 <body class="skin-blue">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Institute Master</li>
          </ol>
        </section>
        <section>
          <center>
    ...
    <fieldset>
    <legend><h1>Institute Master</h1></legend>
    <table cellpadding="7px">
    <form name="institute_master" action="institute_master_conn.php" method="POST">

    <tr><td><label>Institute Code :</label></td>
    <td><input type="number" size="3" name="institute_code" id="institute_code" required="required"
    onblur="validateForm()" /><span id="error1"></span></td></tr>
    <tr><td><label>Institute Name :</label></td>
    <td><input type="text" size="50" name="institute_name" id="institute_name" required="required" onblur="validateForm1()"/><span id="error2"></span></td></tr>
    <tr><td><label>Established Year :</label></td>
    <td><input type="number" size="4" name="est_year" id="est_year" required="required"
    onblur="validateForm2()" /><span id="error3"></span></td></tr>

    <tr><td align="right"><input type="submit" value="Submit" name="Submit"/>&nbsp;&nbsp;&nbsp;</td>
    <td><input type="reset" value= "Clear" name="Delete"/> </td> </tr>
    </form>
    </fieldset>
