      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Feedback Criteria</li>
          </ol>
        </section>
        <section>
          <center>
          ...
          <fieldset>
    <legend><h1>Feedback Criteria</h1></legend>
    <table cellpadding="7px">
    <form name="feedback_criteria" action="feedback_criteria_conn.php" method="POST">

    <tr><td><label>Criteria :</label></td>
    <td><input type="varchar" size="50" name="criteria" id="criteria" required="required"
