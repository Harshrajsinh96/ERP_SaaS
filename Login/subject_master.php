    ...
    function validateForm1()
{
  ...
  if ((sub_code.value).length>8) 
  {
    document.getElementById('subcode').innerHTML = "No More Then 8 digits";
  }
  else
  {
    document.getElementById('subcode').innerHTML = "";
  }
 }
 function validateForm2()
{
        
  if ((sub_name.value).length>100) 
  {
    document.getElementById('subname').innerHTML = "No More Then 100 charactors!!!";
  }
  else
  {
 ...
 function validateForm3()
{
  ...
  if ((sub_acr.value).length>6) 
  {
    document.getElementById('subacr').innerHTML = "No More Then 6 Acronym!!!";
  }
  else
  {
    document.getElementById('subacr').innerHTML = "";
  }
 }
 function validateForm4()
{
        
  if ((sub_credit.value).length>2) 
  {
    document.getElementById('subcre').innerHTML = "No More Then 2 digits!!!!";
  }
  else
  {
    document.getElementById('subacr').innerHTML = "";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section>
          ...
          <fieldset>
    <legend><h1>Subject Master</h1></legend>
    <table cellpadding="7px">
    <form name="subject_master" action="subject_master_conn.php" method="POST" enctype='multipart/form-data'>

      <tr><td><label>Subject Code:</label></td>
      <td><input type="number" size="8" name="sub_code" id="Subject Code" required="required" onblur="validateForm1()"/><span id="subcode"></span></td></tr>
      <tr><td><label>Subject Name:</label></td>
      <td><input type="varchar" size="100" name="sub_name" id="Subject Name" required="required" onblur="validateForm2()"/><span id="subname"></span></td></tr>
      <tr><td><label>Subject Acronym:</label></td>
      <td><input type="varchar" size="6" name="sub_acr" id="Subject Acronym" required="required" onblur="validateForm3()"/><span id="subacr"></span></td></tr>
      <tr><td><label>Subject Credit:</label></td>
      <td><input type="tinyint" size="2" name="sub_credit" id="Subject Credit" required="required" onblur="validateForm4()"/><span id="subcre"></span></td></tr>
      <tr><td><label>Subject Type:</label></td>
      <td><input type="radio" name="sub_type" id="sub_type" value="Primary" required="required">Primary
      <input type="radio" name="sub_type" id="sub_type" value="Elective">Elective</td></tr>
      <tr><td><label>Subject Link:</label></td>
      <td><input type='file' name="subjectlinkfile" required="required"></td></tr>
      <tr><td><label>Subject Status:</label></td>
      <td><input type="radio" name="sub_status" id="sub_status" value="0" required="required">Active
      <input type="radio" name="sub_status" id="sub_status" value="1">Inactive</td></tr>
      ...
      <tr><td><label>Semester :</label></td>
        <td><select name="sem_id" id="sem_id" required="required">
